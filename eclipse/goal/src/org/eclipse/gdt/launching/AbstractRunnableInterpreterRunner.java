 ...
 */
public abstract class AbstractRunnableInterpreterRunner extends AbstractInterpreterRunner {

	public AbstractRunnableInterpreterRunner(final IInterpreterInstall install) {
		super(install);
	}
