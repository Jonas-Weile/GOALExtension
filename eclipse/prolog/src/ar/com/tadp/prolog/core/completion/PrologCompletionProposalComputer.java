 ...
 *
 */
public class PrologCompletionProposalComputer extends ScriptCompletionProposalComputer {

	public PrologCompletionProposalComputer() {
	}

	@Override
	protected ScriptCompletionProposalCollector createCollector(final ScriptContentAssistInvocationContext context) {
		return new PrologCompletionProposalCollector(context.getSourceModule());
	}
}
