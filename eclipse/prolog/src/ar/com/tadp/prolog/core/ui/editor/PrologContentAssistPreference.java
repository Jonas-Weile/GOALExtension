 ...
 *
 */
public class PrologContentAssistPreference extends ContentAssistPreference {
	private static PrologContentAssistPreference instance;

	public static ContentAssistPreference getDefault() {
		if (instance == null) {
			instance = new PrologContentAssistPreference();
		}
		return instance;
	}
