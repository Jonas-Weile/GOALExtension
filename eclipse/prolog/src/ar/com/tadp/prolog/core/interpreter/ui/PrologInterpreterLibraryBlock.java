 ...
 *
 */
public class PrologInterpreterLibraryBlock extends AbstractInterpreterLibraryBlock {

	public PrologInterpreterLibraryBlock(final AddScriptInterpreterDialog d) {
		super(d);
	}
