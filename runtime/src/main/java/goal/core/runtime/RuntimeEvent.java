...
public class RuntimeEvent {
	...
	/**
	 * Event types that relate to platform related events which are NOT generated by
	 * an agent itself.
	 */
	public enum EventType {
		...
		MAS_BORN,
		/**
		 * Event (type) generated when a MAS process has died. Object is associated
		 * MASFileRegistry.
		 */
		MAS_DIED,
		/**
		 * Event (type) generated when an agent has been (partially) created. In case of
		 * messaging, this message is generated when the messagebox for the agent is
		 * created. Object is related Agent or a String with the agent name when agent
		 * is remote.
		 */
		AGENT_BORN,
		/**
		...
		AGENT_DIED,
		/**
		 * The agent was removed entirely from the system. Usually after it was killed.
		 */
		AGENT_REMOVED,
		/**
		...
		SCHEDULER_KILLED,
		/**
		 * Event (type) generated when a GOAL scheduler has selected AT LEAST one or
		 * possibly more agent(s) for execution.
		 */
		SCHEDULER_SELECTED_AGENT,
		/**
		 * Event (type) generated when an environment has been launched by GOAL. Object
		 * is is an Environment.
		 */
		ENVIRONMENT_LAUNCHED,
		/**
		 * Event (type) generated when the run mode of an environment has changed.
		 */
	...
	/**
	 * Object that generated the event or is related to the event (e.g. an agent).
	 */
	 ...
	 * {@link goals.tools.RuntimeEvent.EventType}) and the object that generated the
	 * event or is related to the event (e.g. an agent). Objects that can generate
	 * events are e.g. a multi-agent system (MASFileRegistry), the scheduler, or the
	 * platform manager
	 *
	 * @param type
	 *            type of the event.
