...
/**
 * Executor for the subscribe action.
 */
public class SubscribeActionExecutor extends ActionExecutor {
	/**
	 * Executor for the subscribe action.
	 *
	 * @param action
	 ...
	 */
	SubscribeActionExecutor(SubscribeAction action, Substitution substitution) {
