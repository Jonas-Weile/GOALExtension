...
/**
 * Executor for the unsubscribe action.
 */
public class UnsubscribeActionExecutor extends ActionExecutor {
	/**
	 * Executor for the unsubscribe action.
	 *
	 * @param action
	 ...
	 */
	UnsubscribeActionExecutor(UnsubscribeAction action, Substitution substitution) {
