...
public class PrintActionExecutor extends ActionExecutor {
	 ...
	 *            A print action.
	 * @param substitution
	 *            Substitution for instantiating parameters of the print action.
	 */
	PrintActionExecutor(PrintAction action, Substitution substitution) {
