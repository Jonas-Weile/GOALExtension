...
/**
 * Executor for the cancel timer action.
 */
public class CancelTimerActionExecutor extends ActionExecutor {
	/**
	 * Executor for the cancel timer action.
	 *
	 * @param action
	 *            A cancel timer action.
	 * @param substitution
	 *            Substitution for instantiating parameters of the action.
	 */
	CancelTimerActionExecutor(CancelTimerAction action, Substitution substitution) {
