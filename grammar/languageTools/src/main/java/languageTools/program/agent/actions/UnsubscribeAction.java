 ...
 */
public class UnsubscribeAction extends NonMentalAction {
	/**
	 * Creates a {@link UnsubscribeAction}.
	 *
	 * @param parameters
	 *            The parameters that determine which identifiers to unsubscribe
	 *            from.
	 */
	public UnsubscribeAction(List<Term> parameters, SourceInfo info) {
		super(ModuleValidator.getTokenName(MOD2GParser.UNSUBSCRIBE), info);
	...
	@Override
	public UnsubscribeAction applySubst(Substitution substitution) {
		...
		return new UnsubscribeAction(parameters, getSourceInfo());
	}
}
