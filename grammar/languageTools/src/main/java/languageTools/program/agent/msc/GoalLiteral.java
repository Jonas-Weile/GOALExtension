...
public class GoalLiteral extends MentalLiteral {
	...
	public GoalLiteral(boolean polarity, Selector selector, Query query, Set<String> signatures, SourceInfo info) {
		super(polarity, selector, query, signatures, info);
	}

	@Override
	public MentalLiteral applySubst(Substitution substitution) {
		return new GoalLiteral(isPositive(), (getSelector() == null) ? null : getSelector().applySubst(substitution),
	...
	public String getOperator() {
		return ModuleValidator.getTokenName(MOD2GParser.GOAL_OP);
	}
}
