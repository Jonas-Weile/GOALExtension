...
public class BelLiteral extends MentalLiteral {
	...
	public BelLiteral(boolean polarity, Selector selector, Query query, Set<String> signatures, SourceInfo info) {
		super(polarity, selector, query, signatures, info);
	}

	@Override
	public MentalLiteral applySubst(Substitution substitution) {
		return new BelLiteral(isPositive(), (getSelector() == null) ? null : getSelector().applySubst(substitution),
	...
	public String getOperator() {
		return ModuleValidator.getTokenName(MOD2GParser.BELIEF_OP);
	}
}
