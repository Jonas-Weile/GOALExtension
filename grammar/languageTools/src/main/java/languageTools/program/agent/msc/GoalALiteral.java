...
public class GoalALiteral extends MentalLiteral {
	...
	public GoalALiteral(boolean polarity, Selector selector, Query query, Set<String> signatures, SourceInfo info) {
		super(polarity, selector, query, signatures, info);
	}

	@Override
	public MentalLiteral applySubst(Substitution substitution) {
		return new GoalALiteral(isPositive(), (getSelector() == null) ? null : getSelector().applySubst(substitution),
	...
	public String getOperator() {
		return ModuleValidator.getTokenName(MOD2GParser.GOALA_OP);
	}
}
